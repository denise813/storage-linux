...
static const struct config_item_type simple_children_type = {
	.ct_item_ops	= &simple_children_item_ops,  /*创建属性*/
	.ct_group_ops	= &simple_children_group_ops, /*创建容器即目录*/
	.ct_attrs	= simple_children_attrs,  /*固定属性值*/
	.ct_owner	= THIS_MODULE,
};
