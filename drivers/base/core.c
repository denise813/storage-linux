		       ...
		       const struct device_attribute *attr)
{
	...
	if (dev) {
		...
		WARN(((attr->attr.mode & S_IRUGO) && !attr->show),
			...
			attr->attr.name);
/** comment by hy 2018-10-24
 * # 在/sys/device/XXXX 下对应设备创建属性文件
 */
 ...
 */
/*****************************************************************************
 * 函 数 名  : __root_device_register
 * 负 责 人  : hy
 * 创建日期  : 2018年10月23日
 * 函数功能  :  
 * 输入参数  : const char *name       eg:tcm_user"
               struct module *owner   
 * 输出参数  : 无
 * 返 回 值  : struct
 * 调用关系  : 
