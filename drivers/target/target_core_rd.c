 ...
 */
/*****************************************************************************
 * 函 数 名  : rd_allocate_sgl_table
 * 负 责 人  : hy
 * 创建日期  : 2018年10月22日
 * 函数功能  :  
 * 输入参数  : struct rd_dev *rd_dev              
 ...
 * 调用关系  : 
 * 其    它  :
 table:       |t1....里面的空间为 RD_MAX_ALLOCATION_SIZE=16page|t2....|
 t1:          |scatterlist|scatterlist|scatterlist|......
 scatterlist  |pg
...
/*****************************************************************************
 * 函 数 名  : rd_set_configfs_dev_params
 * 负 责 人  : hy
 * 创建日期  : 2018年10月22日
 * 函数功能  :  
 * 输入参数  : struct se_device *dev   
               const char *page        eg:tokens = "rd_pages=8,rd_nullio=1"
               ssize_t count           
 * 输出参数  : 无
 * 返 回 值  : static
 * 调用关系  : 
