...
/*****************************************************************************
 * 函 数 名  : core_dev_setup_virtual_lun0
 * 负 责 人  : hy
 * 创建日期  : 2018年10月22日
 * 函数功能  : 在内存中创建第一个特殊的lun0设备信息
 * 输入参数  : 
 * 输出参数  : 无
 * 返 回 值  : 
 * 调用关系  : 
...
/** comment by hy 2018-10-22
 * # 填写配置参数 rd_set_configfs_dev_params
 */
	hba->backend->ops->set_configfs_dev_params(dev, buf, sizeof(buf));

/** comment by hy 2018-10-22
 * # 调用后端设备类型的configure_device接口
     rd_configure_device 这里是按照格式配置设备空间
 */
