...
/*****************************************************************************
 * 函 数 名  : transport_backend_register
 * 负 责 人  : hy
 * 创建日期  : 2018年10月21日
 * 函数功能  : 注册目标设备/端口访问端口的操作回调函数
 * 输入参数  : const struct target_backend_ops *ops  端口的操作回调函数
 * 输出参数  : 无
 * 返 回 值  : 
 * 调用关系  : 
 * 其    它  : 
...
/*****************************************************************************
 * 函 数 名  : core_alloc_hba
 * 负 责 人  : hy
 * 创建日期  : 2018年10月21日
 * 函数功能  : 分配主机总线适配器并绑定器后端设备
 * 输入参数  : const char *plugin_name   
               u32 plugin_dep_id         
               u32 hba_flags             
 * 输出参数  : 无
 * 返 回 值  : 
