 ...
 */
/*****************************************************************************
 * 函 数 名  : scsi_eh_scmd_add
 * 负 责 人  : hy
 * 创建日期  : 2019年10月16日
 * 函数功能  :  错误恢复
 * 输入参数  : struct scsi_cmnd *scmd   指向要执行错误恢的SCSI命令描述符的指针
 * 输出参数  : 无
 * 返 回 值  : 
 * 调用关系  : 
 * 其    它  : 
 ...
 */
/*****************************************************************************
 * 函 数 名  : scsi_unjam_host
 * 负 责 人  : hy
 * 创建日期  : 2019年10月16日
 * 函数功能  : 尝试修复一个有故障命令的SCSI主机适配器
 * 输入参数  : struct Scsi_Host *shost  主机适配器描述符的指针
 * 输出参数  : 无
 * 返 回 值  : static
 * 调用关系  : 
 * 其    它  : 
...
/** comment by hy 2018-10-16
 * # 满足错误恢复内核线程运行的条件
     失败的命令数 错误恢复的次数 或失败的命令数不等于已经派发给主机适配器
 */
...
/** comment by hy 2018-10-16
 * # 错误恢复代码，执行完整的错误恢复，SCSI中间层在恢复时执行的所有工作
 */
